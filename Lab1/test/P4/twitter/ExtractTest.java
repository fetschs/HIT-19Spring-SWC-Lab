...
public class ExtractTest {
    ...
    private static final Instant d2 = Instant.parse("2016-02-17T13:00:00Z");
    private static final Instant d3 = Instant.parse("2016-02-17T11:00:00Z");

    private static final Tweet tweet1 = new Tweet(1, "alyssa", "is it reasonable to talk about rivest so much?", d1);
    private static final Tweet tweet2 = new Tweet(2, "bbitdiddle", "rivest talk in 30 minutes #hype", d2);
    private static final Tweet tweet3 = new Tweet(3, "peteratthepark",
            "RT @reallyhoffman: Y'all are stuck in 2018 " + "#hihihi"
                    + "watching the Olympics in 2D while I'm in the future watching it in 3D @https://t.co/CsKHpbZQki",
            d3);
    ...
    public void testGetMentionedUsers() {
        ...
        assertTrue("expected  mentioneduser", mentionedUsers.contains("reallyhoffman"));
        assertFalse("unexpected mentioneduser", mentionedUsers.contains("alyssa"));
    }
    /*
