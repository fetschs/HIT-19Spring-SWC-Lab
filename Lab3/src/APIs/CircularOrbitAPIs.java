...
public class CircularOrbitAPIs {
   ...
   */
  public <L, E> BigDecimal getPhysicalDistance(CircularOrbit<L, E> c, E e1, E e2) throws Exception {
    if (e1 instanceof PositionPhysicalObject && e2 instanceof PositionPhysicalObject) {
      ...
      throw new Exception("Error input, can't calculate physical Distance!");
    }
  }
