...
public class MyClient {
  ...
  private static final Logger exceptionLog = Logger.getLogger("exceptionLogger");
  private static final Logger actionLog = Logger.getLogger("actionLogger");
      ...
      switch (kindStr) {
        case "TrackGame": {
          ...
          while (true) {
            ...
            } catch (SameLabelException | GrammarException | IOException e) {
          ...
          while (!endFlag) {
            ...
            try {
              switch (actions[0]) {
                ...
                case "GUI": {
                  for (CircularOrbit<Athlete, Athlete> circularOrbit : trackGame.getGroups()) {
                    CircularOrbitHelper.draw(circularOrbit);
                  }
                  break;
                }
                case "end": {
        ...
        case "AtomStructure": {
          ...
          while (true) {
            ...
            } catch (GrammarException | IOException
          ...
          while (true) {
            ...
            try {
              socialNetworkCircle = SocialNetworkCircle
                ...
                | IOException | DependencyException e) {
              System.out.println("Please input filename again.");
              exceptionLog.info(
                  e.getClass() + " IN " + kindStr + "." + "creatInstanceFromClient\n" + e
                      .getMessage());
